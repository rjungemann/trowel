---
description: Cut a new patch release. Bump CMakeLists version, update CHANGELOG + README, tag, push.
...
Run a full patch-version release of Trowel. Order matters: the commit
