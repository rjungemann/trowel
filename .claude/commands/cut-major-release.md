...
Run a full major-version release of Trowel. Major releases signal
breaking changes; the CHANGELOG entry should call out any removals or
behavior shifts prominently. Order matters: the commit
